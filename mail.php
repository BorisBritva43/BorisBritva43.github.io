...
$email = 'sanchos8_7@mail.ru'; // адрес куда отправлять письмо, можно несколько через запятую
...
$username = 'ipalexeev98@mail.ru'; // логин вашего почтового ящика
$password = '45hytnc633'; // пароль вашего почтового ящика
